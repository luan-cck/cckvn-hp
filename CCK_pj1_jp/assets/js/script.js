...
smooth_scroll
--------------------*/
  document.querySelectorAll('.service_top_link').forEach(scroll_content => {
  scroll_content.addEventListener('click', event => {
    event.preventDefault();

    const href = scroll_content.getAttribute('href');
